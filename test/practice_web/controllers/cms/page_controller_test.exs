defmodule PracticeWeb.CMS.PageControllerTest do
  use PracticeWeb.ConnCase

  alias Practice.CMS

  @create_attrs %{" views": 42, body: "some body", title: "some title"}
  @update_attrs %{" views": 43, body: "some updated body", title: "some updated title"}
